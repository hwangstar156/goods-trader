...
export function* addWritings(writing, id) {
  try {
...
export function* onAddWritings() {
  yield takeLatest(WritingActionTypes.addWritingStart);
}

export function* onDeleteWritings() {
  yield takeLatest(WritingActionTypes.deleteWritingStart);
}

export function* onfetchWritingData() {
  yield takeLatest(WritingActionTypes.fetchWritingStart);
}
